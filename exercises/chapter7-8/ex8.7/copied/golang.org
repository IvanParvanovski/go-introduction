  ...
  <div class="WhoUsesCaseStudyList">
    <ul class="WhoUsesCaseStudyList-gridContainer">
        ...
        <li class="WhoUsesCaseStudyList-caseStudy">
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://www.cloudwego.io/" aria-label="View CaseStudy of ByteDance, (opens in new window)" target="_blank" rel="noopener" class="WhoUsesCaseStudyList-caseStudyLink">
              <img loading="lazy" height="48" width="30%" src="/images/logos/bytedance_light.svg" class="WhoUsesCaseStudyList-logo" alt=""/>
            </a>
          </li>
          <li class="WhoUsesCaseStudyList-caseStudy">
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://blog.x.com/engineering/en_us/a/2015/handling-five-billion-sessions-a-day-in-real-time.html" aria-label="View CaseStudy of X, (opens in new window)" target="_blank" rel="noopener" class="WhoUsesCaseStudyList-caseStudyLink">
              <img loading="lazy" height="48" width="30%" src="/images/logos/x.png" class="WhoUsesCaseStudyList-logo" alt=""/>
            </a>
          </li>
    </ul>
  </div>
...
<section class="Playground">
  <div class="Playground-gridContainer">
    ...
    <div class="Playground-inputContainer">
      ...
      <textarea class="Playground-input js-playgroundCodeEl" spellcheck="false" aria-label="Try Go" aria-describedby="editor-description" id="code">// You can edit this code!
    ...
    <ul class="WhyGo-reasons">
        <li class="WhyGo-reason">
          ...
          <div class="WhyGo-reasonFooter">
            ...
            <div class="WhyGo-reasonLearnMoreLink">
              <a href="/solutions/cloud/" aria-describedby="newwindow-description">Learn More 
        ...
        <li class="WhyGo-reason">
          ...
          <div class="WhyGo-reasonFooter">
            ...
            <div class="WhyGo-reasonLearnMoreLink">
              <a href="/solutions/clis/" aria-describedby="newwindow-description">Learn More 
              <i class="material-icons WhyGo-forwardArrowIcon" aria-hidden="true">arrow_forward</i></a>
            </div>
          </div>
        </li>
        <li class="WhyGo-reason">
          ...
          <div class="WhyGo-reasonFooter">
            ...
            <div class="WhyGo-reasonLearnMoreLink">
              <a href="/solutions/webdev/" aria-describedby="newwindow-description">Learn More 
              <i class="material-icons WhyGo-forwardArrowIcon" aria-hidden="true">arrow_forward</i></a>
            </div>
          </div>
        </li>
        <li class="WhyGo-reason">
          ...
          <div class="WhyGo-reasonFooter">
            ...
            <div class="WhyGo-reasonLearnMoreLink">
              <a href="/solutions/devops/" aria-describedby="newwindow-description">Learn More 
              <i class="material-icons WhyGo-forwardArrowIcon" aria-hidden="true">arrow_forward</i></a>
            </div>
          </div>
        </li>
